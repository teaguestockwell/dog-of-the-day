...
export function AddImg() {
  ...
  function validateForm(values: IAddFourm) {
    ...
    if (!values.authorName || values.authorName.length > 200) {
    ...
    if (!values.authorImgUrl || values.authorImgUrl.length > 200) {
      errors.authorImgUrl = 'Required'
    }
    if (!values.imgUrl || values.imgUrl.length > 200) {
      errors.imgUrl = 'Required'
    }
    if (!values.imgLink || values.imgLink.length > 200) {
      errors.imgLink = 'Required'
    }
    if (!values.authorBio || values.authorBio.length > 200) {
      errors.authorBio = 'Required'
    }
    if (!values.portfolio_url || values.portfolio_url.length > 200) {
      errors.portfolio_url = 'Required'
    }
